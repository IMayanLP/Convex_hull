...
int main() {
    ...
    std::vector<Object> polygon;
    polygon = carregarOBJ("../assets/cube.obj");

    for (auto object: polygon) {
    ...
    for (auto& object : polygon) {
        object.convex_hull_3d = convexHull3d(object.points);
    }
